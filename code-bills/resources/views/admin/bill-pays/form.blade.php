        ...
        <div class="row">
            <div class="card-panel green lighten-3">
                <span class="green-text text-darken-2">
                    <h5>{{ empty($bank) ? 'Adicionar conta a pagar' : 'Atualizar conta a pagar' }}</h5>
                </span>
            </div>

            <div class="card-panel z-depth-2">
                @if(!empty($bank))
                    {!! Form::model($bank, ['route' => ['admin.bill-pays.update', $bank->id], 'method' => 'PUT']) !!}
                @else
                    {!! Form::open(['route' => 'admin.bill-pays.store', 'method' => 'POST']) !!}
                @endif
                ...
                <div class="row">
                    <div class="col s12 right-align">
                        ...
                        <a class="btn-cancel" href="{{ route('admin.bill-pays.index') }}"
