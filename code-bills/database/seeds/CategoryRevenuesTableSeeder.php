...
class CategoryRevenuesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(\CodeBills\Models\CategoryRevenue::class, 30)
            ->make()
        ...
        foreach ($categoriesRoot as $root) {
            factory(\CodeBills\Models\CategoryRevenue::class, 3)
                ->make()
    ...
    {
        /** @var \CodeBills\Repositories\CategoryRevenueRepository $repository */
        $repository = app(\CodeBills\Repositories\CategoryRevenueRepository::class);
